...
int16_t GY521::read()
{
  ...
  // ACCELEROMETER
  _axraw = _WireRead2();  // ACCEL_XOUT_H  ACCEL_XOUT_L
  _ayraw = _WireRead2();  // ACCEL_YOUT_H  ACCEL_YOUT_L
  _azraw = _WireRead2();  // ACCEL_ZOUT_H  ACCEL_ZOUT_L
  // TEMPERATURE
  _temperature = _WireRead2(); // TEMP_OUT_H    TEMP_OUT_L
  // GYROSCOPE
  _gxraw = _WireRead2();  // GYRO_XOUT_H   GYRO_XOUT_L
  _gyraw = _WireRead2();  // GYRO_YOUT_H   GYRO_YOUT_L
  _gzraw = _WireRead2();  // GYRO_ZOUT_H   GYRO_ZOUT_L
  
#ifdef GY_521_CALC_EXTRA_BS
  // time interval
  uint32_t now = millis();
  ...
  _ax = (float)_axraw * _raw2g;
  _ay = (float)_ayraw * _raw2g;
  _az = (float)_azraw * _raw2g;
  ...
  _gx = (float)_gxraw * _raw2dps;
  _gy = (float)_gyraw * _raw2dps;
  _gz = (float)_gzraw * _raw2dps;
