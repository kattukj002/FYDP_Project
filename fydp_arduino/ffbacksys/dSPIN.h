...
class dSPIN
{
  ...
  public:
    ...
    void setAccTVAL(byte tvalInput, byte index);
    void setAccTVAL(byte tvalInput);
    void setDecTVAL(byte tvalInput, byte index);
    void setDecTVAL(byte tvalInput);
    void setRunTVAL(byte tvalInput, byte index);
    void setRunTVAL(byte tvalInput);
    void setHoldTVAL(byte tvalInput, byte index);
    ...
    byte getAccTVAL(byte index);
    byte getDecTVAL(byte index);
    byte getRunTVAL(byte index);
    byte getHoldTVAL(byte index);
