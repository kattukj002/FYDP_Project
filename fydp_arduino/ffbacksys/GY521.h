...
#define GY521_ACCEL_SENSE_2g  0
#define GY521_ACCEL_SENSE_4g  1
#define GY521_ACCEL_SENSE_8g  2
#define GY521_ACCEL_SENSE_16g 3
...
public:
  ...
  int16_t  getRawAccelX()   { return _axraw; };
  int16_t  getRawAccelY()   { return _ayraw; };
  int16_t  getRawAccelZ()   { return _azraw; };
  ...
  int16_t  getRawGyroX()    { return _gxraw; };
  int16_t  getRawGyroY()    { return _gyraw; };
  int16_t  getRawGyroZ()    { return _gzraw; };
